...
class Config:
    ...
    # test_inputs.npy
    # test_labels.npy
    data_dir: str = r"/home/ubuntu/zq_mae/CSI_data_xtti2ytti_svdDone/multi_E_multi_dB/multi_e_CSI_data/25dB_svd090_norm_8to1_dataset"

    # 模型权重路径
    ckpt_path: str = r"/home/ubuntu/zq_mae/CSI_data_xtti2ytti_svdDone/multi_model_all_zhibiao/Pth_all_model/best.pt"
