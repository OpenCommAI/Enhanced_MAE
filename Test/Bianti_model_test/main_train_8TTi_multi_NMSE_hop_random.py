...
class Config:
    ...
    #   all_speed_dataset/
    #   speed_test_dataset/
    data_root: str = r"/home/ubuntu/zq_mae/CSI_data_xtti2ytti_svdDone/multi_model_all_zhibiao/CSI_data_25dB/SVD_zscore_speed_test_8to1_10to100_step2_last"
    ...
    # 改这里：训练输出目录
    out_root: str = r"./result_new_0604_bianti_v/outputs_multi_hop_speed_test_svd"
...
def main():
    ...
    assert cfg.pred_tti == 1, "当前实验保持 pred_tti=1"
    ...
    run_name = f"multi_hop_speed_8to{cfg.pred_tti}_{timestamp()}"
    ...
    print("=" * 100)
    print("Model type: multi_hop_balanced")
    ...
    with open(log_path, "a", encoding="utf-8") as f:
        f.write("Model type: multi_hop_balanced\n")
    ...
    for epoch in range(1, cfg.epochs + 1):
        ...
        line = (
            f"epoch: {epoch}, "
            f"model_type: multi_hop_balanced, "
