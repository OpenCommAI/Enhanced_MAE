...
class Config:
    ...
    data_dir: str = fr"./data/spectral_efficiency/{num2}dB_zscore_norm_8to1_dataset"
...
# 改成你的 RNN best.pt 路径
CKPT_PATH = "./checkpoints/spectral_efficiency/outputs_rnn_20dB_8to1_1/rnn_8to1_2026-06-03_11-09-51/best.pt"
