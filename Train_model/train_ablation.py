...
class Config:
    ...
    # 改这里：训练结果输出目录
    out_root: str = fr"./result_0604_multi_snr_bianti/outputs_ablation_train_multiscale_only_{num2}dB"
    ...
    # 只对 hop_only 有效。
    # 验证时分别用 1、3、5、7 做 forward，然后对 NMSE 求平均。
...
def main():
    ...
    run_name = f"{cfg.model_type}_train_only_8to{cfg.pred_tti}_{timestamp()}"
