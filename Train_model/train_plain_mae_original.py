...
class Config:
    ...
    all_dataset_name: str = fr"{num1}dB_svd0{num2}_norm_8to1_dataset"

    # 改这里：训练输出保存路径
    out_root: str = fr"./result_0604_multi_snr_bianti/outputs_original_mae_svd_{num1}dB_0{num2}_8to1"
